<template>
  <div class='content'>
    <div class="card columns selected-section" :class="{'no-padding': isOpenedInIFrame}" style='color:#000;'>
      <router-link to="/cryptocurrencies" class="nav-item">
        <div class="return-action mt-3" :class="{'return-action-iframe': isOpenedInIFrame}">
          <icon name="chevron-left" class="arrow-left" :class="{'arrow-left-iframe': isOpenedInIFrame}" height="22" width="22" style='color:#1d253b;'></icon>
      ...
      <div class="column is-7 image-section">
        ...
        <div class="icons-section">
          <span v-if="selectedCryptoCurrency.website" class="icon">
            <a :href="selectedCryptoCurrency.website" target="_blank"><icon name="link" scale="1.5" style='color:#1d253b;'></icon></a>
          </span>
          <span v-if="selectedCryptoCurrency.paper" class="icon">
            <a :href="selectedCryptoCurrency.paper" target="_blank"><icon name="file-text" scale="1.5" style='color:#1d253b;'></icon></a>
          </span>
          <span v-if="selectedCryptoCurrency.github" class="icon">
            <a :href="selectedCryptoCurrency.github" target="_blank"><icon name="github" scale="1.5" style='color:#1d253b;'></icon></a>
          </span>
        </div>
      </div>
