<template>
<div style='color:#000;margin-top:80px;margin-bottom:80px;' class='text-left px-5' id='top-main'>
        ...
        <div>
            <div>
                <div>
                    <div>
                        <div class="header">
                            <h2>Privacy Policy of <strong>darray.org</strong></h2>
                        ...
                        <div class="one_line_col">
                            ...
                            <p>dArray - Napols,59 - La Bisbal d'Empordà, Girona - Spain</p>
                            <p><b>Owner contact email:</b> aulet.jp@gmail.com</p>
                        </div>
                        ...
                        <div class="one_line_col">
                            ...
                            <p>
                                ...
                                Cookies; Usage Data; first name; company name; address; email address; various types of Data.
                            </p>
                        ...
                        <div class="one_line_col">
                            ...
                            <p>
                                ...
                                Analytics, Displaying content from external platforms, Contacting the User and Interaction with external social networks and platforms.
                            </p>
                            ...
                            <ul class="for_boxes">
                                <li>
                                    <div class="box_primary box_10 expand collapsed">
                                        <h3 class="expand-click w_icon_24 policyicon_purpose_6719289">Analytics</h3>
                                ...
                                <li>
                                    <div class="box_primary box_10 expand collapsed">
                                        <h3 class="expand-click w_icon_24 policyicon_purpose_6719292">Contacting the User</h3>
                                        <div class="expand-content" >
                                            ...
                                            <p>
                                                Personal Data collected:
                                                address; company name; email address; first name; various types of Data.
                                            </p>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    <div class="box_primary box_10 expand collapsed">
                                        <h3 class="expand-click w_icon_24 policyicon_purpose_6719290">Displaying content from external platforms</h3>
                                        <div class="expand-content" >
                                ...
                                <li>
                                    <div class="box_primary box_10 expand collapsed">
                                        <h3 class="expand-click w_icon_24 policyicon_purpose_6719293">Interaction with external social networks and platforms</h3>
                                        <div class="expand-content" >
